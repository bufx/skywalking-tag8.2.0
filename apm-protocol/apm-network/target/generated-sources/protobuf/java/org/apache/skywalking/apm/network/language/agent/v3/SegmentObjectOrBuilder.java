...
public interface SegmentObjectOrBuilder extends
   ...
   */
  java.util.List<org.apache.skywalking.apm.network.language.agent.v3.SpanObject> 
      getSpansList();
  /**
   * <pre>
   * Span collections included in this segment.
   ...
   * <code>repeated .SpanObject spans = 3;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.SpanObject getSpans(int index);
  /**
   * <pre>
   * Span collections included in this segment.
   * </pre>
   ...
   * <code>repeated .SpanObject spans = 3;</code>
   */
  java.util.List<? extends org.apache.skywalking.apm.network.language.agent.v3.SpanObjectOrBuilder> 
   ...
   * <code>repeated .SpanObject spans = 3;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.SpanObjectOrBuilder getSpansOrBuilder(
      int index);
