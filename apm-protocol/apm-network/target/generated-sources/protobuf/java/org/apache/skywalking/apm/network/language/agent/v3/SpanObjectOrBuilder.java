...
public interface SpanObjectOrBuilder extends
   ...
   */
  java.util.List<org.apache.skywalking.apm.network.language.agent.v3.SegmentReference> 
      getRefsList();
  /**
   * <pre>
   * &lt;Optional&gt; 
   ...
   * <code>repeated .SegmentReference refs = 5;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.SegmentReference getRefs(int index);
  /**
   * <pre>
   * &lt;Optional&gt; 
   * In the across thread and across process, these references targeting the parent segments.
   ...
   * <code>repeated .SegmentReference refs = 5;</code>
   */
  java.util.List<? extends org.apache.skywalking.apm.network.language.agent.v3.SegmentReferenceOrBuilder> 
   ...
   * <code>repeated .SegmentReference refs = 5;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.SegmentReferenceOrBuilder getRefsOrBuilder(
      int index);
   ...
   * @return The spanType.
   */
  org.apache.skywalking.apm.network.language.agent.v3.SpanType getSpanType();
   ...
   * </pre>
   *
   * <code>.SpanLayer spanLayer = 9;</code>
   ...
   */
  org.apache.skywalking.apm.network.language.agent.v3.SpanLayer getSpanLayer();
   ...
   * </pre>
   *
   * <code>repeated .KeyStringValuePair tags = 12;</code>
   */
   ...
   * </pre>
   *
   * <code>repeated .Log logs = 13;</code>
   */
  java.util.List<org.apache.skywalking.apm.network.language.agent.v3.Log> 
      getLogsList();
  /**
   * <pre>
   * String key, String value pair with an accurate timestamp.
   ...
   * <code>repeated .Log logs = 13;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.Log getLogs(int index);
  /**
   * <pre>
   * String key, String value pair with an accurate timestamp.
   * Logging some events happening in the context of the span duration.
   ...
   * <code>repeated .Log logs = 13;</code>
   */
  java.util.List<? extends org.apache.skywalking.apm.network.language.agent.v3.LogOrBuilder> 
   ...
   * <code>repeated .Log logs = 13;</code>
   */
  org.apache.skywalking.apm.network.language.agent.v3.LogOrBuilder getLogsOrBuilder(
      int index);
