...
public final class AccessLogServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage,
      io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse> getStreamAccessLogsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamAccessLogs",
      requestType = io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage.class,
      responseType = io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage,
      io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse> getStreamAccessLogsMethod() {
    io.grpc.MethodDescriptor<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage, io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse> getStreamAccessLogsMethod;
      ...
      synchronized (AccessLogServiceGrpc.class) {
        if ((getStreamAccessLogsMethod = AccessLogServiceGrpc.getStreamAccessLogsMethod) == null) {
          AccessLogServiceGrpc.getStreamAccessLogsMethod = getStreamAccessLogsMethod =
              io.grpc.MethodDescriptor.<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage, io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "StreamAccessLogs"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage.getDefaultInstance()))
  ...
  public static abstract class AccessLogServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsMessage> streamAccessLogs(
        io.grpc.stub.StreamObserver<io.envoyproxy.envoy.service.accesslog.v2.StreamAccessLogsResponse> responseObserver) {
